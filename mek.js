window.mekApp = (function () {
  ...
  function setupSwipers() {
      ...
      swiperElements.forEach(swiperEl => {
        ...
        const paginationEl = swiperEl.parentElement.querySelector('[data-swiper-pagination]');
    ...
    const initTriggers = () => {
      triggers.forEach((trigger) => {
        ...
        trigger.addEventListener("click", () => {
          ...
          closeText.classList.add("text-size-small", "text-weight-semibold", "text-style-allcaps");
    ...
    // Background color scroll effects
        ...
        gsap.utils.toArray("[data-bg-scroll]").forEach((element) => {
          ...
          if (variableNameMatch) {
            ...
            defaultColor =
              element.getAttribute("data-bg-preload") || "#ffffff";
